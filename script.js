...
const PROJECTS = {
  'marble-sorter': {
    title: 'Marble Sorter',
    description: 'I worked as part of a two-person team to design a machine to sort marbles my color and size. I was resposbile for design of the color sorting system (turntables and gates), mechanical integration of stepper motors, servos, and sensors, and the funnel and loading subsystem.',
